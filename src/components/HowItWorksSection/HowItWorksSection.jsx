...
const HowItWorksSection = () => {
  return (
    <>
      <div className="w-[90%] my-5 max-w-[400px] font-[Poppins] bg-gradient-to-b from-[#3B3AEF] via-[#3B3AEF] to-[#222189] mx-auto rounded-3xl overflow-hidden flex justify-center items-center p-5 sm:w-[95%] sm:max-w-[850px] sm:h-[400px] md:h-[370px] sm:justify-evenly lg:max-w-[1000px] lg:h-[400px] xl:max-w-[1300px] xl:justify-around xl:rounded-4xl xl:h-[470px]">
      ...
      <div className='w-full flex flex-col justify-center items-center py-2.5 gap-5 sm:flex-row lg:justify-evenly lg:gap-0 '>
