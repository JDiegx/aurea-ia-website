...
const FeaturesSection = () => {
    return (
        <div className="w-full h-[380px] flex flex-col items-center justify-evenly sm:h-[220px] sm:flex-row sm:flex-wrap sm:justify-around lg:justify-between xl:justify-evenly px-[30px] lg:h-[140px] ">
            <FeatureCard
                icon={
